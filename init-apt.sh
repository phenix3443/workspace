...
sudo apt update && \
apt upgrade -y && \
apt install -y zssh sshfs tmux shutter curl shadowsocks-libev proxychains4 alacarte aria2 chromium-browser smplayer alacarte google-chrome-stable wine-development
